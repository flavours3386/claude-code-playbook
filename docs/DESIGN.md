...
| 브레이크포인트 | 대상 | 주요 변경 |
|--------------|------|----------|
| ≤767px | 모바일 | 그리드 1열, 패딩 24px→16px, 섹션 간격 80px→48px, h1 1.375rem, 테이블 가로 스크롤 |
| ≤399px | 초소형 | 패딩 16px→12px, h1 1.25rem, 코드블록 폰트 0.6875rem |
| ≥1024px | 데스크톱 | 사이드바 고정 노출, 풀 레이아웃 |
